...
class HomePageProductQuanShorts extends StatelessWidget {
  final User user;
  HomePageProductQuanShorts({required this.user,super.key});
      ...
      child: Column(
        children: [
          ...
          FutureBuilder<List<SanPham?>>(
              future: SanPhamDao.getAllListSanPham('quanshorts'),
