...
class ContentSearchEnter extends StatelessWidget {
  final User user;
  final String keyword;
  const ContentSearchEnter({required this.keyword,required this.user,super.key});
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Text(
                          "Sản Phẩm Bạn Cần Tìm Kiếm \"${keyword}\"",
                          style: TextStyle(
                              fontSize: 20,
                      ...
                      FutureBuilder<List<SanPham?>>(
                          future: SanPhamDao.getAllListSanPhamTimKiem(keyword),
