...
class HomePageProductQuanJean extends StatelessWidget {
  final User user;
  HomePageProductQuanJean({required this.user,super.key});
      ...
      child: Column(
        children: [
          ...
          FutureBuilder<List<SanPham?>>(
              future: SanPhamDao.getAllListSanPham('quanjean'),
